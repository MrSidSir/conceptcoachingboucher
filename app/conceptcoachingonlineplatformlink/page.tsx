...
function CoachingInstitute() {
  ...
  <h2 className="text-3xl font-bold text-center text-blue-600 mb-6">Courses Offered</h2>
  <ul className="space-y-4 text-lg text-gray-700">
    <li className="p-4 border-l-4 border-blue-500 bg-white shadow-sm rounded-md">
      <span className="font-semibold">Mathematics | Science | English</span> (Class 5th-10th)
    </li>
    <li className="p-4 border-l-4 border-green-500 bg-white shadow-sm rounded-md">
      <span className="font-semibold">Physics | Chemistry | Biology | Maths</span> (Class 11th-12th)
    </li>
    <li className="p-4 border-l-4 border-purple-500 bg-white shadow-sm rounded-md">
      <span className="font-semibold">Competitive Exams:</span> IIT-JEE, NEET
    </li>
  </ul>
</section>

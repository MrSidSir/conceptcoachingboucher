...
const ThankYouPage = () => {
  return (
    <div>
      {/* <Image
        src="https://images.pexels.com/photos/4439457/pexels-photo-4439457.jpeg"
        alt="External Image"
        width={500}
        height={300}
        className="absolute"
      /> */}
      <div className="  z-50  relative min-h-screen flex flex-col items-center justify-center bg-gradient-to-r from-blue-500 via-purple-500 to-indigo-500 text-white text-center p-6">
        {/* Heading */}
